...
//    } else {
        self.contentViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"homeViewStoryboard"];
//        
//    }
    
    self.leftMenuViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"mainMenu"];
    
    self.rightMenuViewController = [[UINavigationController alloc] initWithRootViewController:[self.storyboard instantiateViewControllerWithIdentifier:@"chatMenu"]];
...
//    if ([NSStringFromClass([menuViewController class]) isEqualToString:@"UINavigationController"]) {
//        [[NSNotificationCenter defaultCenter]
//         postNotificationName:@"hideRightPanel"
//         object:self
//         userInfo:nil];
//    }
}
